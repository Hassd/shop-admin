  ...
  <div v-loading class="bg-white p-4 rounded">
    <el-form :model="form" label-width="160px">
      <el-tabs v-model="activeName">
        <el-tab-pane label="支付设置" name="firet">
          <el-table :data="tableData" border stripe>
            <el-table-column label="支付方式" width="500">
          ...
          <el-form-item label="已发货的订单">
            <div>
              <el-input
                ...
                type="number"
              >
                <template #append>天后自动完成收货</template>
              </el-input>
            </div>
            <small class="text-gray-500"
    ...
    <FormDrawer ref="formDrawerRef" title="配置" @submit="submit">
      ...
      <el-form v-if="drawerType == 'wxpay'" :model="form" label-width="120px">
